    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="font-title text-3xl text-azul-profundo">Error</h1>
            <p className="text-tierra-media">
            ...
            <Card className="bg-admin-bg-secondary admin-card">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Badge
                    variant={
                      customer.newsletter_subscribed ? "default" : "outline"
                    }
                  >
                                        ...
                                        >
                                          <div className="flex items-center space-x-3">
                                            {product?.featured_image ? (
                                              ...
                                              <div className="w-10 h-10 bg-[#F0EBE0] rounded flex items-center justify-center">
                                ...
                                >
                                  <div className="flex items-center space-x-3">
                                    {item.product?.featured_image ? (
                                      ...
                                      <div className="w-12 h-12 bg-[#F0EBE0] rounded border border-gray-200 flex items-center justify-center">
              ...
              {customer.is_member ? (
                <div className="space-y-4">
                  ...
                  {customer.memberships && customer.memberships.length > 0 && (
                    <div>
                      <h4 className="font-medium mb-3 text-azul-profundo">
                        Programa Actual
                      </h4>
                      {customer.memberships.map((membership: any) => (
                        <div
                          key={membership.id}
                          className="p-4 border rounded-lg bg-[#F6FBD6] border-verde-suave/30"
                        >
                          <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2">
                                <div className="flex-1 bg-[#E5DFD3] rounded-full h-2">
                                  <div
                                    className="bg-verde-suave h-2 rounded-full transition-all"
                                    style={{
                                      width: `${membership.progress_percentage || 0}%`,
                                    }}
                                  />
                                </div>
                            ...
                            <div>
                              ...
                              <p className="font-medium text-azul-profundo">
                                {membership.completed_lessons || 0} /{" "}
                                {membership.total_lessons || 28}
                              </p>
                            </div>
                          </div>
